...
function NgxFileDropComponent_ng_template_4_div_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r4.dropZoneLabel);
  }
}
function NgxFileDropComponent_ng_template_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("click", function NgxFileDropComponent_ng_template_4_div_1_Template_input_click_1_listener($event) {
      ...
      return ɵɵresetView(ctx_r6.openFileSelector($event));
    });
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵpropertyInterpolate("value", ctx_r5.browseBtnLabel);
    ɵɵproperty("className", ctx_r5.browseBtnClassName);
  }
}
...
_NgxFileDropComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function NgxFileDropComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵelementEnd();
      ɵɵtemplate(4, NgxFileDropComponent_ng_template_4_Template, 2, 2, "ng-template", null, 4, ɵɵtemplateRefExtractor)(6, NgxFileDropComponent_ng_template_6_Template, 0, 0, "ng-template", 5);
      ɵɵelementEnd()();
    }
    if (rf & 2) {
      ...
      ɵɵadvance(4);
      ɵɵproperty("ngTemplateOutlet", ctx.contentTemplate || _r2)("ngTemplateOutletContext", ɵɵpureFunction1(13, _c1, ctx.openFileSelector));
    }
  },
